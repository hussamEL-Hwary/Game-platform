...
public class RegistrationTest {
  ...
  {
	  return new Object[][] {{true,"youef@gmail.com","1111"},{false,"abod@gmail.com","4444"},{true,"omar@yahoo.com","1234"}};
  }
  
  @DataProvider(name ="loginAsTeacherData")
  public Object[][] GetloginAsTeachertData()
  {
	  return new Object[][] {{true,"sasa@yahoo.com","123456789"},{false,"hussam@gmail.com","4444"},{true,"jo@gamil.com","1233"}};
  }
  ...
  {
	  return new Object[][]{{true,"Omar","moratak@gmail.com","124456",20,'m'},{false,"yousef","jo@gamil.com","1233",5,'m'}};
  }
  ...
  @Test(enabled=false, dataProvider="loginAsStudentData")
  ...
  @Test(enabled=false, dataProvider="loginAsTeacherData")
